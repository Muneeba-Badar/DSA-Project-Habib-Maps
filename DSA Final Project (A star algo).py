...
Original file is located at
    https://colab.research.google.com/drive/1bxIph7mS9WgAUegjqR3YasFXTCVHTq6M
"""
...
def heuristic(node1, node2):
    ...
    coordinates = {'stairs':(0,3), 'music room':(0,5), 'linux lab':(0,8), 'graphics lab':(4,8), 'E-011 classroom':(6,8), 'E-012 classroom':(8,8), 'tapal cafeteria':(11,5), 'projects lab':(9,1), 'power lab':(6,1), 'circuits and electronics lab':(3,1), 'female lounge':(0,1)} #3
    x1,y1 = coordinates[node1]
    x2,y2 = coordinates[node2]
    return round(math.sqrt((x1 - x2)**2 + (y1 - y2)**2),2)

nodes = ["stairs", "music room", "linux lab", "graphics lab", "E-011 classroom", "E-012 classroom", "tapal cafeteria", "projects lab", "power lab", "circuits and electronics lab", "female lounge"]
edges = [['stairs','music room',5],['music room','stairs',5],['music room','linux lab',3],['linux lab','music room',3],['linux lab','graphics lab',7],['graphics lab','linux lab',7],['graphics lab','E-011 classroom',3],['E-011 classroom','graphics lab',3],['E-011 classroom','E-012 classroom',1],['E-012 classroom','E-011 classroom',1],['E-012 classroom','tapal cafeteria',14],['tapal cafeteria','E-012 classroom',14],['tapal cafeteria','projects lab',7],['projects lab','tapal cafeteria',7],['projects lab','power lab',5],['power lab','projects lab',5],['power lab','circuits and electronics lab',5],['circuits and electronics lab','power lab',5],['circuits and electronics lab','stairs',5],['stairs','circuits and electronics lab',5],['stairs','tapal cafeteria',15],['tapal cafeteria','stairs',15],['stairs','female lounge',8],['female lounge','stairs',8]]
G={}
addNodes(G, nodes)
...
def display_map():
    ...
    for i in lst: #iterates through the list of path provided by navigating_habib function
        ...
        tr.shape("arrow") #sets the shape of the turtle (can be square, arrow, circle, turtle, triangle, classic)
        tr.color("yellow") #sets the color of the turtle
